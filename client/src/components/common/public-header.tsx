          ...
          <div className={"relative flex h-16 justify-between sm:-ml-8"}>
            <div className={"flex grow"}>
              <div className={"flex w-1/3 justify-between items-center"}>
                ...
                <h1 className="hidden sm:block text-white text-3xl font-bold text-nowrap"><span className="text-sky-500">P2P</span> <span className="text-gray-900 dark:text-white">METER</span></h1>
                </Link>
              </div>
